...
while (beginning_date < end_date):
    ...
    if(beginning_date.weekday() == 5 or beginning_date.weekday() == 6):
        ...
        if (beginning_date >= datetime.date(2021,1,1) and beginning_date < datetime.date(2021,1,15)) or (beginning_date >= datetime.date(2021,4,1) and beginning_date < datetime.date(2021,4,15)) or (beginning_date >= datetime.date(2021,7,1) and beginning_date < datetime.date(2021,7,15)) or (beginning_date >= datetime.date(2021,10,1) and beginning_date < datetime.date(2021,10,15)):
            menge_einzelteile_a = random.randrange(math.ceil(130 - 130*regression1),math.ceil(150 - 150*regression1),1)
            ...
            for menge in range(menge_einzelteile_a):
                fertigungszeit_einzelteil_a = random.randrange(math.ceil(500 + 500*regression1), math.ceil(700 + 700*regression1))
            ...
            menge_einzelteile_a = random.randrange(math.ceil(130 - 130*regression2),math.ceil(150 - 150*regression2),1)
            menge_montage = random.randrange(math.ceil(57 -57*regression2), math.ceil(83 -83*regression2),1)
            for menge in range(menge_einzelteile_a):
                fertigungszeit_einzelteil_a = random.randrange(math.ceil(500 + 500*regression2), math.ceil(700 + 700*regression2))
                qualitaetsmessung_einzelteil_a = random.randrange(math.ceil(90 - 90*regression0), math.ceil(100 - 100*regression05))
                ws_et['A' + str(row_einzelteil)].value = id_einzelteil
                ws_et['B' + str(row_einzelteil)].value = beginning_date
                ws_et['C' + str(row_einzelteil)].value = TYP_EINZELTEIL_A
                ws_et['D' + str(row_einzelteil)].value = fertigungszeit_einzelteil_a
            ...
            menge_einzelteile_a = random.randrange(math.ceil(130 - 130*regression3),math.ceil(150 - 150*regression3),1)
            menge_montage = random.randrange(math.ceil(57 -57*regression3), math.ceil(83 -83*regression3),1)
            for menge in range(menge_einzelteile_a):
                fertigungszeit_einzelteil_a = random.randrange(math.ceil(500 + 500*regression3), math.ceil(700 + 700*regression3))
                qualitaetsmessung_einzelteil_a = random.randrange(math.ceil(90 - 90*regression05), math.ceil(100 - 100*regression05))
                ws_et['A' + str(row_einzelteil)].value = id_einzelteil
                ws_et['B' + str(row_einzelteil)].value = beginning_date
                ws_et['C' + str(row_einzelteil)].value = TYP_EINZELTEIL_A
                ws_et['D' + str(row_einzelteil)].value = fertigungszeit_einzelteil_a
            ...
            menge_einzelteile_a = random.randrange(math.ceil(130 - 130*regression4),math.ceil(150 - 150*regression4),1)
            menge_montage = random.randrange(math.ceil(57 -57*regression4), math.ceil(83 -83*regression4),1)
            for menge in range(menge_einzelteile_a):
                fertigungszeit_einzelteil_a = random.randrange(math.ceil(500 + 500*regression4), math.ceil(700 + 700*regression4))
                qualitaetsmessung_einzelteil_a = random.randrange(math.ceil(90 - 90*regression05), math.ceil(100 - 100*regression1))
                ws_et['A' + str(row_einzelteil)].value = id_einzelteil
                ws_et['B' + str(row_einzelteil)].value = beginning_date
                ws_et['C' + str(row_einzelteil)].value = TYP_EINZELTEIL_A
                ws_et['D' + str(row_einzelteil)].value = fertigungszeit_einzelteil_a
            ...
            menge_einzelteile_a = random.randrange(math.ceil(130 - 130*regression5),math.ceil(150 - 150*regression5),1)
            menge_montage = random.randrange(math.ceil(57 - 57*regression5), math.ceil(83 - 83*regression5),1)
            for menge in range(menge_einzelteile_a):
                fertigungszeit_einzelteil_a = random.randrange(math.ceil(500 + 500*regression5), math.ceil(700 + 700*regression5))
                qualitaetsmessung_einzelteil_a = random.randrange(math.ceil(90 - 90*regression1), math.ceil(100 - 100*regression1))
                ws_et['A' + str(row_einzelteil)].value = id_einzelteil
                ws_et['B' + str(row_einzelteil)].value = beginning_date
                ws_et['C' + str(row_einzelteil)].value = TYP_EINZELTEIL_A
                ws_et['D' + str(row_einzelteil)].value = fertigungszeit_einzelteil_a
        ...
        # else: 
            menge_einzelteile_a = random.randrange(math.ceil(130 - 130*regression6),math.ceil(150 - 150*regression6),1)
            menge_montage = random.randrange(math.ceil(57 -57*regression6), math.ceil(83 -83*regression6),1)
            for menge in range(menge_einzelteile_a):
                fertigungszeit_einzelteil_a = random.randrange(math.ceil(500 + 500*regression6), math.ceil(700 + 700*regression6))
                qualitaetsmessung_einzelteil_a = random.randrange(math.ceil(90 - 90*regression1), math.ceil(100 - 100*regression15))
                ws_et['A' + str(row_einzelteil)].value = id_einzelteil
                ws_et['B' + str(row_einzelteil)].value = beginning_date
                ws_et['C' + str(row_einzelteil)].value = TYP_EINZELTEIL_A
                ws_et['D' + str(row_einzelteil)].value = fertigungszeit_einzelteil_a
